...
struct db_query db_postgres_queries[] = {
    ...
    },
    {
         ...
         .query = "SELECT  id, status, destination, msatoshi, payment_hash, timestamp, payment_preimage, path_secrets, route_nodes, route_channels, msatoshi_sent, description, bolt11, failonionreply, total_msat, partid, local_offer_id, groupid FROM payments WHERE payment_hash = $1 ORDER BY timestamp ASC;",
         .placeholders = 1,
         .readonly = true,
    },
    {
