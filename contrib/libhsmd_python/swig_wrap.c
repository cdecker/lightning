...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__libhsmd

#else
#  define SWIG_init    init_libhsmd

#endif
#define SWIG_name    "_libhsmd"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_handle(PyObject *self, PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "handle", 4, 4, swig_obj)) SWIG_fail;
  ecode1 = SWIG_AsVal_long_SS_long(swig_obj[0], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "handle" "', argument " "1"" of type '" "long long""'");
  } 
  arg1 = (long long)(val1);
  ecode2 = SWIG_AsVal_long_SS_long(swig_obj[1], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "handle" "', argument " "2"" of type '" "long long""'");
  } 
  arg2 = (long long)(val2);
  res3 = SWIG_AsCharPtrAndSize(swig_obj[2], &buf3, NULL, &alloc3);
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "handle" "', argument " "3"" of type '" "char *""'");
  }
  arg3 = (char *)(buf3);
  res4 = SWIG_AsCharPtrAndSize(swig_obj[3], &buf4, NULL, &alloc4);
  if (!SWIG_IsOK(res4)) {
    SWIG_exception_fail(SWIG_ArgError(res4), "in method '" "handle" "', argument " "4"" of type '" "char *""'");
  }
  arg4 = (char *)(buf4);
  result = (char *)handle(arg1,arg2,arg3,arg4);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "handle", _wrap_handle, METH_VARARGS, NULL},
